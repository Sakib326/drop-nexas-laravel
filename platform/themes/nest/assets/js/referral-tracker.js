...
(function () {
    ...
    const referralUsername = getQueryParam("fromre");
    if (referralUsername) {
    ...
    if (window.location.pathname.includes("register")) {
        ...
        document.addEventListener("DOMContentLoaded", function () {
            const referralField = document.querySelector(
                'input[name="referral_username"]',
            );
            const savedReferral = getReferralUsername();
